...
double ZHH6CFit::JetEnergyResolution(double E)
{
...
ZHH6CFit::ZHH6CFit() : Processor("ZHH6CFit") {
  
  // modify processor description
  _description = "ZHH6CFit does a kinematic fit on 2 lepton + 4 jet events with 4C from 4-momentum conservation + 2C from MH = 125 GeV" ;
...
void ZHH6CFit::processRunHeader( LCRunHeader* ) { 
  _nRun++ ;
} 

void ZHH6CFit::processEvent( LCEvent * evt ) { 
