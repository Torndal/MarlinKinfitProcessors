...
class ZHllqq5CFit : public Processor
{
	...
	private:
		...
		bool					m_traceall{};
		int					m_ievttrace{};
		float					m_JetResThetaCoeff{};
		float					m_JetResPhiCoeff{};
		...
		floatVector				m_SigmaPx2{};
		floatVector				m_SigmaPxPy{};
		floatVector				m_SigmaPxPz{};
		floatVector				m_SigmaPxE{};
		floatVector				m_SigmaPy2{};
		floatVector				m_SigmaPyPz{};
		floatVector				m_SigmaPyE{};
