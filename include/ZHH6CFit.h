...
class ZHH6CFit : public Processor {
  
 public:
  
  virtual Processor*  newProcessor() { return new ZHH6CFit ; }

  ZHH6CFit(const ZHH6CFit&) = delete ;
  ZHH6CFit& operator=(const ZHH6CFit&) = delete ;  
